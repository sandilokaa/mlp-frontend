    ...
    <Router>
      <SnackbarProvider maxSnack={3}>
        <Routes>
          ...
          ></Route>
          <Route
            path="/lecturer/assignment/detail/"
            element={<AssignmentDetail />}
          >
            <Route path=":id" element={<AssignmentDetail />} />
          </Route>
          <Route
            path="/lecturer/assignment/update/"
          ...
          <Route
            path="/expertisegroup/assignment"
            element={<ExpertiseGroupAssignment />}
          ></Route>
          <Route
            path="/expertisegroup/assignment/detail/"
            element={<ExpertiseGroupAssignmentDetail />}
          >
