                                    ...
                                    <Form>
                                            ...
                                            <Col xl={12}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        <Form.Label style={{ fontSize: '14px' }}>Judul Penelitian <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                        ...
                                        <Row className="mt-3">
                                            <Col xl={4}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        <Form.Label style={{ fontSize: '14px' }}>Kategori Penelitian <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                            ...
                                            <Col xl={4}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        <Form.Label style={{ fontSize: '14px' }}>Periode Penelitian <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                            ...
                                            <Col xl={4}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        <Form.Label style={{ fontSize: '14px' }}>Tahun Ajaran <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                        ...
                                        <Row className="mt-3">
                                            <Col xl={12}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        <Form.Label style={{ fontSize: '14px' }}>Upload Dokumen Penelitian <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                                        <div
                                                                    ...
                                                                    fileNames ? (
                                                                        <Col xl={12} className="d-flex justify-content-start">
                                                                            <div style={{display:'flex', gap: '10px' , padding: '5px 10px', background: '#FAFAFA', borderRadius: '4px', zIndex: '999'}}>
                                                                                ...
                                                                                <p style={{ margin: 'auto 0' }}>{fileNames}</p>
                                                                        ...
                                                                        <>
                                                                            ...
                                                                            <Col xl={{ span: 2, offset: 5 }} className="text-center mt-2">
                                                                                <p style={{ margin: 'auto 0' }}>Drag and drop filemu atau <span style={{ color: '#2181E8' }}>telusuri</span></p>
                                                                            </Col>
                                                                        </>
                                                                    )
                                                                }
                                        ...
                                        <Row className="mt-4">
                                            <Col xl={12} className="d-flex justify-content-end">
                                                <Button style={{ background: '#D62C35', border: 'none' }}> Tambah Penelitian </Button>
                                            </Col>
                                        </Row>
                                    </Form>
                                </div>
