                ...
                <Container fluid style={{ padding: '0 20px 0 32px' }}>
                    <Row>
                        <Col xl={12} className="d-flex align-items-center">
                            <Image onClick={() => navigate('/dean/lecturer/list')} src={ArrowLeft} style={{ marginRight: '16px', cursor: 'pointer' }} />
...
export default DeanLecturerDetail;