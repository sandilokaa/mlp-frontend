...
const ExpertiseGroupResearch = () => {
    ...
    const exportResearchData = async () => {
        ...
        if (researchData) {
            ...
            doc.setFontSize(16);
            doc.text('Laporan Penelitian Dosen', textXPosition, marginTop + 10);
            ...
            tableData.push(['No', 'Judul Penelitian', 'Nama Dosen', 'Email']);

            researchData.map((item, index) => {
                return tableData.push([index + 1, item.researchName, item.Lecturer.name, item.Lecturer.email]);
            });
            ...
            doc.save('data-penelitian.pdf', { autoDownload: false });
                                                ...
                                                <Col xl={1} className="text-center" style={{ marginLeft: '1px' }}>
                                                    <Row style={{ display: 'flex', padding: '0', margin: '0' }}>
                                                        <Col xl={12} className="d-flex justify-content-center p-0">
                                                            <span className="view" onClick={() => navigate(`/expertisegroup/research/detail/${research.id}`)}>
                                                                <Image src={ViewIcon} />
                                                            </span>
                                                        </Col>
                                                    </Row>
...
export default ExpertiseGroupResearch;