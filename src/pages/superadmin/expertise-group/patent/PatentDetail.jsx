...
const ExpertiseGroupPatentDetail = () => {
        ...
        const onPatentById = async () => {
            ...
            try {
                ...
                const getPatentRequest = await axios.get(
                    `http://localhost:8080/api/v1/superadmin/patent/${id}`,
                    {
                        headers: {
                ...
                <Container fluid style={{ padding: '0 32px' }}>
                    <Row className="detail-research-title">
                        <Col xl={12} className="d-flex align-items-center">
                            <Image onClick={() => navigate('/expertisegroup/patent')} src={ArrowLeft} style={{ marginRight: '16px', cursor: 'pointer' }} />
...
export default ExpertiseGroupPatentDetail;