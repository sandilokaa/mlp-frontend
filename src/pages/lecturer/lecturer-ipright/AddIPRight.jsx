...
const AddIPRight = () => {
    ...
    const onCreateIPRight = async () => {
        ...
        try {
            ...
            const iprightPayloadRequest = await axios.post(
                                    ...
                                    <Form>
                                            ...
                                            <Col xl={12}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput1">
                                                        ...
                                                        <Form.Control type="text" placeholder="Masukan judul paten" autoComplete="off" style={{ fontSize: '14px' }} ref={iPRightTitleField} />
                                                    </Form.Group>
                                                </div>
                                            </Col>
                                        </Row>
                                            ...
                                            <Col xl={6}>
                                                <div>
                                                    <Form.Group controlId="exampleForm.ControlInput2">
                                                        ...
                                                        <Form.Control type="date" placeholder="Masukan tanggal publikasi" autoComplete="off" style={{ fontSize: '14px' }} onChange={handleIPRightDate} />
                                                    </Form.Group>
                                                </div>
                                            </Col>
                                            <Col xl={6}>
                                        ...
                                        <Row className="mt-3">
                                            <Col xl={12}>
                                                <div>
                                                    <Form.Group>
                                                        <Form.Label style={{ fontSize: '14px', color: '#292929' }}>Upload Lampiran HAKI <span style={{ color: '#EA4D55' }}>*</span></Form.Label>
                                                        <div
                                        ...
                                        <Row className="mt-4">
                                            <Col xl={12} className="d-flex justify-content-end">
                                                <Button onClick={onCreateIPRight} style={{ background: '#D62C35', border: 'none', fontSize: '16px' }}> Tambah HAKI </Button>
                                            </Col>
                                        </Row>
                                    </Form>
                                </div>
